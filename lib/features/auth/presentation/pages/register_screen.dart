...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _onRegister() {
    ...
    final isTermsAccepted = _acceptedTerms;

    setState(() {
      _hasAttemptedValidation = true;
      _termsError = isTermsAccepted ? null : l10n.registerTermsError;
    });
    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        ...
        builder: (context, state) {
          final l10n = AppLocalizations.of(context)!;
          final registerLoading = state is RegisterInProgress;
                ...
                children: [
                  ...
                  AuthTextField(
                    ...
                    validator: (value) => AuthValidators.emailRequiredDotCom(
                      value,
                      requiredMessage:
                          l10n.validationEmailRequiredDotComRequired,
                  ...
                  AuthPrimaryButton(
                    ...
                    onPressed: registerLoading ? null : _onRegister,
                  ),
                  const SizedBox(height: 24),
                  Center(
                    child: TextButton(
