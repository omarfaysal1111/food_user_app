...
mixin _$UserSettingsDto {
 ...
 String get id; String? get locale; bool? get pushNotifications; bool? get smsNotifications; bool? get emailNotifications; String? get theme;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,locale,pushNotifications,smsNotifications,emailNotifications,theme);

@override
String toString() {
  return 'UserSettingsDto(id: $id, locale: $locale, pushNotifications: $pushNotifications, smsNotifications: $smsNotifications, emailNotifications: $emailNotifications, theme: $theme)';
}
...
@useResult
$Res call({
 String id, String? locale, bool? pushNotifications, bool? smsNotifications, bool? emailNotifications, String? theme
});
...
/// Create a copy of UserSettingsDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? locale = freezed,Object? pushNotifications = freezed,Object? smsNotifications = freezed,Object? emailNotifications = freezed,Object? theme = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? locale,  bool? pushNotifications,  bool? smsNotifications,  bool? emailNotifications,  String? theme)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserSettingsDto() when $default != null:
return $default(_that.id,_that.locale,_that.pushNotifications,_that.smsNotifications,_that.emailNotifications,_that.theme);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? locale,  bool? pushNotifications,  bool? smsNotifications,  bool? emailNotifications,  String? theme)  $default,) {final _that = this;
switch (_that) {
case _UserSettingsDto():
return $default(_that.id,_that.locale,_that.pushNotifications,_that.smsNotifications,_that.emailNotifications,_that.theme);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? locale,  bool? pushNotifications,  bool? smsNotifications,  bool? emailNotifications,  String? theme)?  $default,) {final _that = this;
switch (_that) {
case _UserSettingsDto() when $default != null:
return $default(_that.id,_that.locale,_that.pushNotifications,_that.smsNotifications,_that.emailNotifications,_that.theme);case _:
  return null;
...
class _UserSettingsDto implements UserSettingsDto {
  const _UserSettingsDto({required this.id, this.locale, this.pushNotifications, this.smsNotifications, this.emailNotifications, this.theme});
...
/// Create a copy of UserSettingsDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? locale = freezed,Object? pushNotifications = freezed,Object? smsNotifications = freezed,Object? emailNotifications = freezed,Object? theme = freezed,}) {
